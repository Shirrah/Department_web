        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>    
                ...
                <div class="collapse" id="adminsMenu">
                    <ul class="nav flex-column ps-3">
                        <li>
                            <a href="?content=admin-index&admin=admin-management" class="nav-link text-white"><i class="bi bi-chevron-right"></i>  Manage Admins</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="collapse" id="eventsFeesMenu">
                    <ul class="nav flex-column ps-3">
                        <li>
                            <a href="?content=admin-index&admin=event-management&admin_events=admin-events" class="nav-link text-white"><i class="bi bi-chevron-right"></i>  Manage Events</a>
                        </li>
                        <li>
                            <a href="?content=admin-index&admin=event-management&admin_events=admin-fees" class="nav-link text-white"><i class="bi bi-chevron-right"></i>  Manage Fees</a>
                        </li>
                    </ul>
                </div>
            </li>
